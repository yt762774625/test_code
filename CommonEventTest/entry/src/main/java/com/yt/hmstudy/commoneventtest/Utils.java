package com.yt.hmstudy.commoneventtest;
...
public class Utils {
    ...
    private static final String S_BUNDLE_NAME = "com.yt.hmstudy.javaui";

    // HiLogLabel定义了域信息和标签等
    private static final HiLogLabel S_LOG_LABEL = new HiLogLabel(HiLog.LOG_APP, 0x00101, "JavaUI");
